...
function getLoginErrorMessage(code?: string, fallback?: string) {
  if (code === "user_not_found") {
    return "No account found for that email. Create your account below.";
  }
    ...
    <div className="min-h-screen bg-[#050b08] text-white">
      <div className="flex min-h-screen items-center justify-center px-4 py-12">
        <div className="flex w-full max-w-md flex-col gap-4">
          <Link
            href="/"
            className="inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/75 shadow-[0_10px_28px_rgba(0,0,0,0.2)] backdrop-blur-xl hover:border-[#ff4d4f]/40 hover:bg-[#ff4d4f]/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff4d4f]/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#050b08]"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
          ...
          <div className="w-full rounded-[32px] border border-white/10 bg-[#0a130f]/90 p-8 shadow-[0_24px_90px_rgba(0,0,0,0.38)] backdrop-blur-xl">
